...
import { ShaderPass, SSAOShader } from 'three-addons';
...
THREE.SSAOPass = function ( scene, camera, width, height ) {
	...
	this.uniforms[ 'tDiffuse' ].value = 4;
...
THREE.SSAOPass.prototype = Object.create( ShaderPass.prototype );
